...
function RemoveContextMenu {
    ...
    Remove-Item -Path Registry::HKEY_CLASSES_ROOT\SystemFileAssociations\.jpg\shell\ImageToPAA -Recurse -Force
    Remove-Item -Path Registry::HKEY_CLASSES_ROOT\SystemFileAssociations\.jpeg\shell\ImageToPAA -Recurse -Force
}
